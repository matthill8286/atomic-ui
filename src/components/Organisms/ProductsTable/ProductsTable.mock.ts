...
export const tableHeadingDataMock = [
  {
    productId: '2247449',
    product: {
...
export const tableContentDataMock = [
  {
    tableRow: [
      {
        text: 'RAM',
    ...
    tableRow: [
      {
        ...
        image: {
          url:
            'https://mms-test.cdn.prismic.io/mms-test/0e3789245ff064b99b7f7a8cb5fddecf696167c0_icon_pp.png',
    ...
    tableRow: [
      {
        ...
        image: {
          url:
            'https://mms-test.cdn.prismic.io/mms-test/82cb314aef9c37f8379bd350eb50d8eb47bbd8b3_icon_word.png',
          __typename: 'GQLImageField',
        },
        isFeatureName: true,
        type: 'paragraph+image',
    ...
    tableRow: [
      {
        ...
        image: {
          url:
            'https://mms-test.cdn.prismic.io/mms-test/eba8dab06f037e9a196a6f8e0bc94ad02d8ea724_icon_excel.png',
          __typename: 'GQLImageField',
        },
        isFeatureName: true,
        type: 'paragraph+image',
