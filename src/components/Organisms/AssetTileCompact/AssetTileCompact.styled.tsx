...
export const StyledAssetTileCompactWrapper = styled.div`
  display: flex;
  flex-direction: row;
...
export const StyledAssetTileCompactElementWrapper = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
`
...
export const StyledAssetImage = styled(AssetImage)<{
  width?: number
  height?: number
}>`
  flex: 1;
