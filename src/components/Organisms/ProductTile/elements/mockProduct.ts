...
import { CollectionData } from '@/components/Organisms/ProductTile'

export const newProductMocks: Product[] = [
  {
    __typename: 'Product',
    id: 29104,
    coverImage: '',
    ...
    interaction: {
      ...
      launched: false,
      bookmarked: true,
      completed: { locked: false, status: true, rating: '' },
    },
    type: { __typename: 'Type', id: 2, name: 'Video' },
    timebox: {
      __typename: 'Timebox',
    ...
    description:
      'Rothman explores the environment in which leaders and leadership arises, claiming that “people who fetishize leadership sometimes find themselves longing for crisis”. He goes on to explore how leadership styles have evolved through the ages and the problems the modern leader faces. He hath the power to go forth and conquer will be victorious, and happy beyond your dreams',
    embedVideoURL:
  ...
  },
  {
    ...
    partOfSession: '0',
    embedded: true,
    provider: { __typename: 'Provider', id: 31, name: 'Microsoft', logoUrl: '' },
    interaction: {
      __typename: 'Interaction',
      launched: false,
      bookmarked: true,
    ...
    competencies: [
      ...
      { __typename: 'Competency', id: 1512, text: 'Have a go' },
      { __typename: 'Competency', id: 1513, text: 'Learn and enjoy learning' },
      {
        __typename: 'Competency',
        id: 1514,
        text: 'Be a lot more open than closed ',
  ...
  },
  {
    ...
    id: 31484,
    image:
      'https://i.kinja-img.com/gawker-media/image/upload/s--4xb6xHba--/c_fit,fl_progressive,q_80,w_636/txaexeer4cr7buvkaked.jpg',
    ...
    language: 'en',
    partOfSession: '0',
    provider: { __typename: 'Provider', id: 34, name: 'Nexus', logoUrl: '' },
    interaction: {
      __typename: 'Interaction',
      launched: false,
      bookmarked: false,
  ...
  },
  {
    ...
    id: 29161,
    image:
      'https://pocket-image-cache.com/direct?resize=w2000&url=https%3A%2F%2Fwww.farnamstreetblog.com%2Fwp-content%2Fuploads%2F2016%2F04%2FMunger-Operating-System.jpg',
    ...
    language: 'en',
    partOfSession: '0',
    provider: { __typename: 'Provider', id: 457, name: 'Saiyan', logoUrl: '' },
    interaction: {
      __typename: 'Interaction',
      launched: false,
      bookmarked: false,
    ...
    competencies: [
      ...
      { __typename: 'Competency', id: 1510, text: 'Focus on what’s important' },
      { __typename: 'Competency', id: 1512, text: 'Have a go' },
    ],
    author: 'Pocket',
    description:
  ...
  },
  {
    ...
    id: 29187,
    image:
      'https://i1.wp.com/fsd.servicemax.com/wp-content/uploads/0213_jargon_Gavin-Llewellyn.jpg?fit=400%2C207&ssl=8',
    ...
    partOfSession: '0',
    coverImage: '',
    provider: { __typename: 'Provider', id: 31, name: 'Apple', logoUrl: '' },
    interaction: {
      __typename: 'Interaction',
      launched: false,
      bookmarked: false,
...
export const newProductStructuredMocks: Product[] = [
  {
    __typename: 'Product',
    id: 29104,
    coverImage: '',
  ...
  },
  {
    ...
    interaction: {
      ...
      launched: false,
      bookmarked: true,
      completed: { locked: true, status: true, rating: '' },
    },
    locked: true,
    type: { __typename: 'Type', id: 2, name: 'Video' },
    timebox: {
...
export const newStaticProductMocks: Product[] = [
  {
    __typename: 'Product',
    id: 29104,
    coverImage: '',
  ...
  },
  {
    ...
    id: 29147,
    coverImage: '',
    image: 'https://hbr.org/resources/images/article_products/2018/08/R1805B_SPOT_HERO.jpg',
    niceName: '29147-why-curiosity-matters',
    url: 'https://hbr.org/2018/09/curiosity)',
    title: 'Why Curiosity Matters',
    duration: '45 minutes',
...
export const mockPlaylistCollection1: CollectionData = {
  title: 'Shut Up and Sit Down: Why the leadership industry rules.',
  __typename: 'Playlist',
  ...
  image:
    'https://pocket-image-cache.com/direct?resize=w2000&url=https%3A%2F%2Fwww.farnamstreetblog.com%2Fwp-content%2Fuploads%2F2016%2F04%2FMunger-Operating-System.jpg',
  numberOfProducts: 45,
  totalProductDuration: 6,
}

export const mockPlaylistCollection2 = {
  title: 'The Best Sounds for Getting Work Done',
  __typename: 'Playlist',
  id: 90,
  ...
  image: 'https://hbr.org/resources/images/article_products/2018/08/R1805B_SPOT_HERO.jpg',
  numberOfProducts: 7,
  totalProductDuration: 3,
}

export const mockPlaylistCollection3 = {
  title: 'The Munger Operating System: How to Live a Life That Really Works',
  __typename: 'Playlist',
  id: 77,
  ...
  image:
    'https://i1.wp.com/fsd.servicemax.com/wp-content/uploads/0213_jargon_Gavin-Llewellyn.jpg?fit=400%2C207&ssl=8',
  numberOfProducts: 76,
  totalProductDuration: 2,
}

export const mockPlaylistCollections: CollectionData[] = [
  mockPlaylistCollection1,
  mockPlaylistCollection2,
  mockPlaylistCollection3,
  mockPlaylistCollection1,
  mockPlaylistCollection2,
  mockPlaylistCollection3,
]
