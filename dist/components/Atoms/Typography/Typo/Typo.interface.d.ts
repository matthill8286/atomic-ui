import { BoxDimensions, ThemeColors, ThemeFontFamilies, ThemeFontLetterSpacing, ThemeFontLineHeight, ThemeFontSizes, ThemeFontWeights } from '@/types/theme';
export declare type TextAlign = 'left' | 'right' | 'center';
export declare type BorderRadius = 'borderRadius0' | 'borderRadius1' | 'borderRadius2';
...
//# sourceMappingURL=Typo.interface.d.ts.map